        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="tab-coc-container" class="space-y-6">
                ...
                <div id="page-coc" class="relative w-full max-w-[850px] mx-auto bg-white shadow-2xl overflow-hidden print:shadow-none print:w-full block">
                    ...
                    <div class="absolute inset-0 text-[11px] font-bold uppercase tracking-tight data-container" style="font-family: 'Times New Roman', Times, serif !important;">
                        <div class="absolute top-[140px] left-[630px]">{{ $policy->policy_no }}</div>
                        ...
                        <!-- Date Issued -->
                        <div class="absolute top-[210px] left-[475px]">{{ strtoupper(\Carbon\Carbon::parse($policy->created_at)->format('M-d-y')) }}</div>
                        <!-- Validity Dates -->
                        <div class="absolute top-[260px] left-[475px]">{{ strtoupper(\Carbon\Carbon::parse($policy->created_at)->format('M-d-y')) }}</div>
                        <div class="absolute top-[260px] left-[630px]">{{ strtoupper(\Carbon\Carbon::parse($policy->created_at)->addYear()->format('M-d-y')) }}</div>
                        ...
                        <div class="absolute top-[315px] left-[460px] max-w-[130px] leading-tight" style="line-height: 1;">{{ $policy->color }}</div>
                        <div class="absolute top-[315px] left-[605px]">{{ preg_replace('/^(\d{6})0+(\d+)/', '$1-$2', $policy->mv_file) }}</div>
                ...
                <div id="page-policy" class="relative w-full max-w-[850px] mx-auto bg-white shadow-2xl overflow-hidden print:shadow-none print:w-full block">
                    ...
                    <div class="absolute inset-0 text-[11px] font-bold uppercase tracking-tight data-container" style="font-family: 'Times New Roman', Times, serif !important;">
                        ...
                        <div class="absolute top-[320px] left-[585px]">{{ preg_replace('/^(\d{6})0+(\d+)/', '$1-$2', $policy->mv_file) }}</div>
            ...
            <div id="tab-invoice-container" class="relative w-full max-w-[580px] mx-auto bg-white shadow-2xl overflow-hidden print:shadow-none print:w-full" style="display: none;">
                ...
                <div class="absolute inset-0 text-[10px] font-bold uppercase tracking-tight data-container" style="font-family: 'Times New Roman', Times, serif !important;">
                    <!-- Invoice Date -->
                    <div class="absolute top-[127px] left-[195px]">{{ strtoupper(\Carbon\Carbon::parse($policy->created_at)->format('M-d')) }}</div>
                    <div class="absolute top-[127px] left-[278px]">{{ strtoupper(\Carbon\Carbon::parse($policy->created_at)->format('y')) }}</div>
                    ...
                    <!-- Plate Number -->
                    <div class="absolute top-[183px] left-[228px]">{{ $policy->plate_no }}</div>
